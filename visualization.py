...
def save_images(img_tensors, img_names, clo_names, save_dir):
    for img_tensor, img_name, clo_name in zip(img_tensors, img_names, clo_names):
        ...
        name = img_name[:-4]+"_"+clo_name[:-4]+".jpg"
        Image.fromarray(array).save(os.path.join(save_dir, name))
